...
#define PERF_SAMPLE_MS 300000          // 5 min (288 amostras = 24h)
...
#define TASK_AUDIO_INTERVAL 2
#define TASK_PERSISTENCIA_INTERVAL 300000  // 5 minutos
...
#define TASK_PERSISTENCIA_PRIORITY (configMAX_PRIORITIES - 8)  // Baixa prioridade
