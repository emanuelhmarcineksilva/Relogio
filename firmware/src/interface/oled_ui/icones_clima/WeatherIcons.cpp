...
int getTipoClima(float temp, int weather_code) {
  // Prioridade 1: Extremos de temperatura (ajustado para ser menos agressivo)
  if (temp < 10.0f) return 0;    // NEVE / FRIO EXTREMO (0)
  if (temp >= 32.0f) return 4;   // TERMÔMETRO / QUENTE (4)
