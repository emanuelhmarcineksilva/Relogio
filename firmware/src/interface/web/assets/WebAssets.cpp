...
<div class="card"><b>Sobre o Projeto Chronos Obsidian</b><br>Universidade: Pontifícia Universidade Católica do Paraná (PUCPR).<br>Integrantes: EMANUEL HENRIQUE MARCINEK SILVA, GABRIEL MOLETA ROSSI, JULIO MIGUEL CZAPLINSKI KUCHUMINSKI, MURILO BIZZ, MURILO PRIZIBELA.<br>Contato: emanuel. Silva1@pucpr.edu.br<br>GitHub: <a href="https://github.com/emanuelhmarcineksilva/Relogio" style="color:#4ade80">Link Repositório</a></div>
<div class="card"><b>Guia de Changelog (V4.0.0)</b><br>• Arquitetura RTOS Dual-Core com 4 tasks independentes.<br>• Modularização de hardware (RtcService, DhtService, AlarmService).<br>• Persistência de performance 24h com validação de integridade CRC32.<br>• Sensor Task otimizada no Core 0 e UI Task dedicada no Core 1.</div>
